...
class RecepcionVisitaController extends Controller
{
    /**
    ...
    */
    public function index(Request $request)
    {
        ...
        $visita = Visita::select(
            'visita.*',
            'visitante.*',
            DB::raw("DATE_FORMAT(visita.fecha_visita, '%d/%m/%Y') AS fecha_visita"),
    ...
    */
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'id_usuario_seguridad' => 'required|numeric|exists:usuario,id_usuario',            
        ...
        // $paramet['fecha_visita'] = date('Y-m-d', strtotime($request->fecha_visita));
